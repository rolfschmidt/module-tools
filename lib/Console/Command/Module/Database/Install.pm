...
package Console::Command::Module::Database::Install;
...
Console::Command::Module::Database::Install - Console command to execute the <DatabaseInstall> section of a module.

=head1 DESCRIPTION

Runs Database install part from a module .sopm file.
